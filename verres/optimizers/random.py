...
class RandomSearchCallback(tf.keras.callbacks.Callback):

    def on_epoch_end(self, epoch, logs=None):
        if not isinstance(self.model.optimizer, UniformRangeSearch)


class RandomSearchOptimizer(tf.keras.optimizers.Optimizer):
